...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        while i <= cell[0] + 1 :
            while j <= cell[1] + 1:
                if not((i < 0 or j < 0) or (i > self.height-1 or j > self.width-1)):
                    cells.add((i, j))
                j+=1
            i+=1
            j-=3
            ...
            for sentence in list(self.knowledge):
                ...
                for sentence2 in list(self.knowledge):
                    ...
                    if sentence.cells.issubset(sentence2.cells):
                        self.knowledge.append(Sentence(sentence2.cells.difference(sentence.cells), sentence2.count-sentence.count))
